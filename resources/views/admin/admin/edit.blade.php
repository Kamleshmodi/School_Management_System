            ...
            <div class="card card-primary">
              <form method="post" action="">
                ...
                <div class="card-body">
                    ...
                    <input type="password" class="form-control" name = "password"  value="{{ $getRecord->password }}" required placeholder="Password">
                    <p>Note: Password will not be changed if you don't enter password</p>
                    </div>
                </div>

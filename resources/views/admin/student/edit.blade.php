            ...
            <form method="post" action="" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="admission_number" value="{{ $getRecord->admission_number }}" readonly>
                  </div>
              ...
              <hr/>
                  ...
                  <div class="form-group">
                    ...
                    <p> Due you want to change password, please add new password <a href="{{ asset('admin/change_password') }}">here</a></p>
                  </div>
              </div>

...
class User extends Authenticatable
{
    ...
    {
        $return = self::select('users.*' , 'class.name as class_name', 'parent.name as parent_name', 'parent.last_name as parent_last_name', 'parent.email as parent_email')
    ...
    {
        $lastStudent = self::whereNotNull('admission_number')->orderBy('id', 'desc')->first();
        ...
        return date('Y') . '-' . $newNumber; // Example: 2025-0001
    }
    ...
    static public function getTeacherStudent($teacher_id)
    {
        $return = self::select('users.*' , 'class.name as class_name')
                    ...
                    ->join('assigned_class_teacher', 'assigned_class_teacher.class_id', '=', 'class.id')
    ...
    {
        if(!empty($this->profile_pic) && file_exists(public_path('uploads/profile/'.$this->profile_pic)))
        {
            return asset('uploads/profile/'.$this->profile_pic);
        }
        else
        {
            return "";

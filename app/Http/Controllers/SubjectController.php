...
class SubjectController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if ($request->name == 'OTHERS' && !empty($request->other_subject)) {
            $save->name = trim($request->other_subject); // Save custom subject
        } else {
            $save->name = trim($request->name); // Save selected subject
        }
    ...
    public function update($id, Request $request)
    {
        ...
        $save->name = ($request->name == "OTHERS") ? $request->other_subject : $request->name;
